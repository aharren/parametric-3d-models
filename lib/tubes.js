...
const main = (params) => {
  const objects = [];
  objects.push(tube({ height: 50, outerRadius: 15, innerRadius: 12 }));
  objects.push(tubeElliptic({ height: 50, startOuterRadius: [10, 10], startInnerRadius: [9, 9], endOuterRadius: [20, 20], endInnerRadius: [19, 19] }));
  objects.push(tubeElliptic({ height: 50, startOuterRadius: [20, 20], startInnerRadius: [8, 8], endOuterRadius: [10, 10], endInnerRadius: [8, 8] }));
