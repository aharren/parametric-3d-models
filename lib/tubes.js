...
const tubeCurvedElliptic = (options) => {
  ...
  return translate([center[0] - curveRadius, center[1], center[2]], tube);
};
...
const main = (params) => {
  ...
  // tubeCurved
  objects.push(colors.yellow(tubeCurved({ outerRadius: 15, innerRadius: 13, angle: degToRad(30), curveRadius: 40 })));

  // tubeCurvedElliptic
  objects.push(colors.yellow(tubeCurvedElliptic({ outerRadius: [15, 12], innerRadius: [13, 10], angle: degToRad(-30) })));
